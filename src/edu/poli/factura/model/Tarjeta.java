...
public class Tarjeta extends FormaDePago {
	...
	public Tarjeta(String pagoaANombreDe, String identificacion) {
		super(pagoaANombreDe, identificacion);
	}

	public Tarjeta(String pagoaANombreDe, String identificacion, String numeroTarjeta, String titular) {
		super(pagoaANombreDe, identificacion);
